...
export default function BlogPage() {
  return (
    <main className="py-18">
      ...
      <div className="space-y-10">
        {posts.map((post) => (
          ...
          >
            ...
            {/* Description */}
            <p className="mt-2 text-sm text-gray-600 leading-6 max-w-2xl">
              {post.description}
            </p>
          </a>
        ))}
      ...
      {/* Empty State (Future) */}
      {posts.length === 0 && (
        <div className="mt-20 border border-dashed border-gray-300 rounded-xl p-10 text-center bg-gray-50">
