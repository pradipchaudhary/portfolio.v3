...
export default function AboutMe() {
    return (
        <section id="introduction" className="fade-up text-slate-500">
            <h1 className="text-2xl font-bold mb-4 fade-up">
                Hi there, <span className="wave text-slate-400">👋</span>
            </h1>

            {/* p1 */}
            <p className="text-lg fade-up text-slate-500">
                I&apos;m an enthusiastic{" "}
                <Link
            ...
            {/* p2 */}
            <p className="text-lg my-4 fade-up text-slate-500">
                As a{" "}
                <strong>
                    Full-Time{" "}
                    <Link
