...
export default function FollowMeSocial() {
  ...
  return (
    <section className="relative flex flex-col items-center gap-2 rounded-xl px-6 py-6 sm:mt-16">
      ...
      <motion.p
        ...
        className={`absolute text-base font-semibold tracking-wide text-gray-600 dark:text-gray-600  text-center animate-blinker ${caveat.className}
  ...
  md:-top-14 md:left-1/2`}
      ...
      <motion.div
        ...
        className="absolute top-6 left-[60%] -translate-x-1/2 animate-blinker md:-top-10 md:left-1/2"
      >
        <svg
          width="70"
          height="70"
        ...
        >
          <g clipPath={`url(#${clipId})`} className="animate-fill">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
